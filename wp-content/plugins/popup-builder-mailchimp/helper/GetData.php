...
class GetOptionsData {
	...
	public static function getDefaultValues() {
		...
		$defaultParams = array(
			'mailchimp-disable-double-optin' => false,
			'mailchimp-list-id' => '',
			'mailchimp-indicates-required-fields' => true,
			'sg-mailchimp-form' => '',
			'mailchimp-required-error-message' => 'This field is required',
			'mailchimp-email-validate-message' => 'Please enter valid email',
			'mailchimp-submit-button-bgcolor' => '',
			'mailchimp-form-aligment' => 'center',
			'mailchimp-label-aligment' => 'center',
			'mailchimp-success-message' => 'You have successfully subscribed to our mail list.',
			'mailchimp-error-message' => 'Too many subscribe attempts for this email address',
			'mailchimp-only-required' => '',
			'mailchimp-show-form-to-top' => '',
			'mailchimp-label-color' => '',
			'mailchimp-input-width' => '',
			'mailchimp-input-height' => '',
			'mailchimp-input-border-radius' => '',
			'mailchimp-input-border-width' => '2px',
			'mailchimp-input-border-color' => '',
			'mailchimp-input-bg-color' => '',
			'mailchimp-input-text-color' => '',
			'mailchimp-submit-width' => '150',
			'mailchimp-submit-height' => '40',
			'mailchimp-submit-border-width' => '2px',
			'mailchimp-submit-border-radius' => '2px',
			'mailchimp-submit-border-color' => '',
			'mailchimp-submit-color' => '',
			'mailchimp-submit-title' => 'Subscribe',
			'mailchimp-email-label' => 'Email Address',
			'mailchimp-asterisk-label' => 'indicates required',
			'mailchimp-success-behavior' => 'showMessage',
			'mailchimp-success-redirect-url' => '',
			'mailchimp-success-popups-list' => '',
			'mailchimp-success-redirect-new-tab' => '',
			'mailchimp-close-popup-already-subscribed' => 0
		);

		return $defaultParams;
	}

	public static function getOptionValue($options) {

		$allData = array();
		$options = json_decode($options, true);

		foreach ($options as $key => $value) {
			$allData[$key] = self::sgSafeStr($value);
		}
	...
	public static function sgSafeStr ($param) {

		return ($param===null?'':$param);
	}

	public static function formAlignmentOptions() {
	...
	public static function labelAlignmentOptions() {
		...
		$behavior = array(
			array(
				...
				"data-attributes" => array(
					"class" => "js-mailchimp-success-message"
				)
			...
			array(
				...
				"info" => "",
				"data-attributes" => array(
					"class" => "js-mailchimp-success-redirect"
				)
