			...
			<div id="normal-sortables" class="meta-box-sortables ui-sortable">
				<div class="postbox js-advanced-postbox">
					...
					<div class="advanced-options-content">
						...
						<span class="dashicons dashicons-info  same-image-style"></span><span class="infoForMobile samefontStyle">If this option is selected, the popup will appear only on mobile devices.</span><br>
