<?php
/**
 * Plugin Name: Popup Builder PRO
 * Popup Builder Exit Intent
...
$isFreeActive = is_plugin_active('popup-builder/popup-builder.php');

if($isFreeActive) {
	wp_die("Please, deactivate the FREE version of Popup Builder plugin before upgrading to PRO.");
}
else {
	popupBuilderProActivate();
}

function popupBuilderProActivate() {
