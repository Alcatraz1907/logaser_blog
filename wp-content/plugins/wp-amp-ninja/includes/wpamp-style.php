...
<style amp-custom>
	...
	body > header #header .brand{ font-size: 20px; font-weight: bold; line-height: 1; margin: 0px; width: 84%; float:left; padding-left:10px; }
	body > header #header .brand a{ color:#FFF; }
	...
	body > section article.post h1, body > section article.post h1 a{ line-height: 20px; font-size: 20px; margin: 5px 0 5px 0px; text-align:center; }
	...
	body > section article.post ul.amp-wp-meta li.amp-wp-byline .amp-wp-author {color: #FE0033 text-transform: capitalize; }
	body > section article.post ul.amp-wp-meta li.amp-wp-byline .amp-wp-author a:hover {color: #FE0033; cursor: text }
	...
	body > section article.post .catlisting a:hover{ color: #fff; border-color: transparent; background: #FE0033;}
	...
	body > section #amp-pagination .next a:hover, body > section #amp-pagination .prev a:hover{ color: #fff; border-color: transparent; background: #FE0033;}
</style>