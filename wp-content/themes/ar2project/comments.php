...
<?php if ( post_password_required() ) : ?>
	<div id="comments" class="comments">
		<p class="module-title"><?php _e('Password Required', 'ar2') ?></p>
...
?>
	...
	<p class="module-title"><?php comments_number( __( 'No Comments', 'ar2' ), __( '1 Comment', 'ar2' ), _n( '% Comment', '% Comments', get_comments_number(), 'ar2' ) ); ?></p>
	...
	<p class="module-title"><?php _e( 'Trackbacks / Pings', 'ar2' ) ?></p>
