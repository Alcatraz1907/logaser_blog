...
<article id="post-<?php the_ID() ?>" <?php post_class() ?>>
	...
	<header class="entry-header clearfix">
		...
		<h1 class="entry-title"><?php if ( false !== get_post_format() ) : ?><span class="entry-format"><?php echo get_post_format_string( get_post_format() ) ?></span><?php endif ?><a href="<?php the_permalink() ?>" rel="bookmark"><?php the_title() ?></a></h1>
	...
	<footer class="entry-footer clearfix">
        ...
        <?php if ( ar2_get_theme_option( 'post_display[display_author]' ) ) : ?>
			...
			<div class="about-author clearfix">
				<div class="author-avatar" ><?php echo get_avatar( $id, 64 ) ?></div>
				<div class="author-meta">
					<p><?php printf( __( 'About %s', 'ar2' ), get_the_author_meta( 'display_name' ) ) ?></p>
					<?php 
