...
/* Added custom function to remove archives - http://mekshq.com/remove-archives-wordpress-improve-seo/ */
function logaster_remove_wp_archives() {
...
add_action('template_redirect', 'logaster_remove_wp_archives');
